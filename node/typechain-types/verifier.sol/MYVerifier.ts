...
export interface MYVerifierInterface extends Interface {
...
export interface MYVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): MYVerifier;
  waitForDeployment(): Promise<this>;

  interface: MYVerifierInterface;
