...
export interface RBTVerifierInterface extends Interface {
...
export interface RBTVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): RBTVerifier;
  waitForDeployment(): Promise<this>;

  interface: RBTVerifierInterface;
